# 🏠 Локализация построек и чертежей (Society: Sunlit Valley)

В этой папке находятся сгенерированные файлы русской локализации для меню построек и чертежей.

## 📂 Расположение файлов в игре
...
## 🏛️ Перечень категорий построек (`society_trading`)
...
## 🎨 Стили чертежей (`portable_blueprints`)

Всего переведено **399 ключей** чертежей (названия зданий, авторы проектов и размеры построек) для всех стилей:
* **Базовый (Basic)**
* **Альпийский (Alpine)**
* **Пустынный (Arid)**
* **Бамбуковый (Bamboo)**
...
* **Цветочный (Floral)**
* **Каменный (Mason)**
* **Призмариновый (Prismarine)**
* **Деревенский (Rural)**
* **Сакура (Sakura)**
* **Сибирский (Siberian)**
* **Тюдоровский (Tudor)**
* **Яркоград (Vibrantown)**
* **Сосновый городок (Pineconetown)**
