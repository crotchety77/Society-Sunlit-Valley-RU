ItemEvents.tooltip((tooltip) => {
  ...
  tooltip.add(
    ...
    Text.translatable("tooltip.cluttered.willow_log").gray()
  );
  tooltip.add(
    "cluttered:willow_sapling",
    Text.translatable("tooltip.cluttered.willow_sapling").gray()
  );
  tooltip.add(
    "atmospheric:grimwood_sapling",
    Text.translatable("tooltip.atmospheric.grimwood_sapling").gray()
  );
  // Hammers
  tooltip.add(
  ...
  tooltip.add(
    ...
    Text.translatable(
      ...
      Text.translatable("block.society.seed_maker").gold()
    ).gray()
  );
  tooltip.add(
    "society:pink_matter",
    Text.translatable(
      ...
      Text.translatable("block.society.cheese_press").gold()
    ).gray()
  );
  tooltip.add(
    "society:stone_hand",
    Text.translatable(
      ...
      Text.translatable("block.society.preserves_jar").gold()
    ).gray()
  );
  tooltip.add(
    ...
    Text.translatable(
      ...
      Text.translatable("block.society.aging_cask").gold()
    ).gray()
  );
  tooltip.add(
    "society:sea_biscut",
    Text.translatable(
      ...
      Text.translatable("block.society.fish_pond").gold()
    ).gray()
  );
  tooltip.add(
    "society:black_opal",
    Text.translatable(
      ...
      Text.translatable("block.society.crystalarium").gold()
    ).gray()
  );
  tooltip.add(
    "society:enkephalin",
    Text.translatable(
      ...
      Text.translatable("block.society.mayonnaise_machine").gold()
    ).gray()
  );
  tooltip.add(
    "society:tiny_gnome",
    Text.translatable(
      ...
      Text.translatable("block.society.loom").gold()
    ).gray()
  );
  tooltip.add(
    "society:ancient_roe",
    Text.translatable(
      ...
      Text.translatable("block.society.fish_smoker").gold()
    ).gray()
  );
  tooltip.add(
    "society:frosted_tip",
    Text.translatable(
      ...
      Text.translatable("block.society.charging_rod").gold()
    ).gray()
  );
  tooltip.add(
    ...
    Text.translatable(
      ...
      Text.translatable("block.society.deluxe_worm_farm").gold()
    ).gray()
  );
  tooltip.add(
    "society:inserter",
    Text.translatable(
      ...
      Text.translatable("block.society.ancient_cask").gold()
    ).gray()
  );
  tooltip.add(
    "society:cordycep",
    Text.translatable(
      ...
      Text.translatable("block.society.dehydrator").gold()
    ).gray()
  );
  tooltip.add(
    ...
    Text.translatable(
      ...
      Text.translatable("block.society.wine_keg").gold()
    ).gray()
  );
  tooltip.add(
    ...
    Text.translatable(
      ...
      Text.translatable("block.society.recycling_machine").gold()
    ).gray()
  );
  tooltip.add(
    [
  ...
  const generateSprinklerTooltip = (tooltip, tier, radius) => {
    ...
    tooltip.add(
      `dew_drop_farmland_growth:${tier}_sprinkler`,
      Text.translatable(
        "tooltip.society.sprinkler.area",
