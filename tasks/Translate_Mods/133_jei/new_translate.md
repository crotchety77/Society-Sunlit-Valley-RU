# Локализация мода: jei

**JAR:** `jei-1.20.1-forge-15.20.0.129.jar` | **Всего строк:** 132 | **Не переведено:** 25
...
```json
{
  "_comment": "TODO: Debug (for a debug mode, do not need translation)",
  "jei.tooltip.show.all.recipes.hotkey": "TODO: Press \"%s\" to show all recipes.",
  "jei.tooltip.liquid.flowing": "TODO: %s (Flowing)",
  "jei.tooltip.item.search.aliases": "TODO: Search Aliases:",
  "jei.tooltip.lookupHistory.enable": "TODO: Show JEI Lookup History",
  "jei.tooltip.lookupHistory.disable": "TODO: Hide JEI Lookup History",
  "jei.tooltip.lookupHistory.usage": "TODO: Shows a list of the ingredients recently used for looking up recipes.",
  "gui.jei.category.tagInformation": "TODO: %s Tags",
  "gui.jei.category.tagInformation.block": "TODO: Block Tags",
  "gui.jei.category.tagInformation.fluid": "TODO: Fluid Tags",
  "gui.jei.category.tagInformation.item": "TODO: Item Tags",
  "gui.jei.category.recipe.crashed": "TODO: This recipe crashed. Please see the client logs for details.",
  "jei.key.combo.shift": "TODO: SHIFT + %s",
  "jei.key.combo.control": "TODO: CTRL + %s",
  "jei.key.combo.command": "TODO: CMD + %s",
  "jei.key.combo.alt": "TODO: ALT + %s",
  "jei.key.shift": "TODO: SHIFT",
  "description.jei.wooden.door.1": "TODO: Wooden doors allow you to block monsters from entering your building.\\nTesting sentences.",
  "description.jei.wooden.door.2": "TODO: Clicking on a door changes its state from open to closed and vice versa.",
  "description.jei.wooden.door.3": "TODO: Wooden doors can be opened/closed via redstone circuits.",
  "description.jei.debug.formatting.1": "TODO: Testing %s formatting replacements.",
  "description.jei.debug.formatting.2": "TODO: Testing %s %s formatting replacements.",
  "description.jei.debug.formatting.3": "TODO: %s nested",
  "jei.alias.panda.spawn.egg": "TODO: endangered",
  "jei.alias.villager.spawn.egg": "TODO: HMMM"
}
```
...
```json
{
  ...
  "jei.key.category.overlays": "JEI (наложения)",
  ...
  "jei.key.category.recipe.gui": "JEI (рецепты)",
  ...
  "jei.key.category.cheat.mode": "JEI (режим жульничества)",
  ...
  "jei.key.category.hover.config.button": "JEI (Наведение мышью на кнопку конфигурации)",
  "key.jei.toggleCheatModeConfigButton": "Вкл/выкл режим жульничества",
  "jei.key.category.edit.mode": "JEI (режим правки)",
  ...
  "jei.key.category.mouse.hover": "JEI (Наведение мышью)",
