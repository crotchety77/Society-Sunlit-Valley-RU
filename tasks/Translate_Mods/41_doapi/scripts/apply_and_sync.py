...
# -*- coding: utf-8 -*-
r"""
Скрипт применения и синхронизации локализации для мода 'doapi'.
1. Считывает переводы из new_translate.md.
2. Сохраняет в translations/mods/doapi.json.
3. Записывает напрямую в D:\ModrinthApp\profiles\Society_ Sunlit Valley\kubejs\assets\doapi\lang\ru_ru.json.
...
LOCAL_MOD_JSON = os.path.join(ROOT_DIR, "translations", "mods", "doapi.json")
GAME_RU_PATH = r"D:\ModrinthApp\profiles\Society_ Sunlit Valley\kubejs\assets\doapi\lang\ru_ru.json"
...
def apply_and_sync():
    ...
    print(f"💾 Обновлён translations/mods/doapi.json (всего {len(local_data)} ключей)")
