...
# -*- coding: utf-8 -*-
r"""
Скрипт применения и синхронизации локализации для мода 'dew_drop_watering_cans'.
1. Считывает переводы из new_translate.md.
2. Сохраняет в translations/mods/dew_drop_watering_cans.json.
3. Записывает напрямую в D:\ModrinthApp\profiles\Society_ Sunlit Valley\kubejs\assets\dew_drop_watering_cans\lang\ru_ru.json.
...
LOCAL_MOD_JSON = os.path.join(ROOT_DIR, "translations", "mods", "dew_drop_watering_cans.json")
GAME_RU_PATH = r"D:\ModrinthApp\profiles\Society_ Sunlit Valley\kubejs\assets\dew_drop_watering_cans\lang\ru_ru.json"
...
def apply_and_sync():
    ...
    print(f"💾 Обновлён translations/mods/dew_drop_watering_cans.json (всего {len(local_data)} ключей)")
