# Локализация мода: patchouli

**JAR:** `Patchouli-1.20.1-85-FORGE.jar` | **Всего строк:** 90 | **Не переведено:** 3
...
```json
{
  "item.patchouli:intro_book.name": "TODO: Patchouli",
  "patchouli.gui.lexicon.sad": "TODO: :(",
  "patchouli.gui.lexicon.button.resize.verybig.container": "TODO: %s?"
}
```
...
```json
{
  ...
  "patchouli.gui.lexicon.mark_complete": "Пометить: завершено",
  "patchouli.gui.lexicon.mark_incomplete": "Пометить: не завершено",
  "patchouli.gui.lexicon.button.prev_page": "Предыдущая",
