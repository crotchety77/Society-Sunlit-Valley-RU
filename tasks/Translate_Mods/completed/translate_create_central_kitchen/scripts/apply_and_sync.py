...
# from tasks/Translate_Mods/03_.../scripts -> dirname(__file__) is scripts
# .. -> 03_create_central_kitchen
# .. -> Translate_Mods
# .. -> tasks
# .. -> workspace
BASE_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..', '..', '..'))
TASK_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), '..'))
TRANSLATIONS_FILE = os.path.join(BASE_DIR, 'translations', 'mods', 'create_central_kitchen.json')
GAME_LANG_DIR = r"D:\ModrinthApp\profiles\Society_ Sunlit Valley\kubejs\assets\create_central_kitchen\lang"
