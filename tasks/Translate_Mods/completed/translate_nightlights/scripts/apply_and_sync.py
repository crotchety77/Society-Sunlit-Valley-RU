...
# -*- coding: utf-8 -*-
"""
Скрипт применения и синхронизации локализации для мода 'nightlights'.
1. Считывает переводы из new_translate.md.
2. Сохраняет в translations/mods/nightlights.json.
...
LOCAL_MOD_JSON = os.path.join(ROOT_DIR, "translations", "mods", "nightlights.json")
...
def apply_and_sync():
    ...
    print(f"💾 Обновлён translations/mods/nightlights.json (всего {len(local_data)} ключей)")
