...
# -*- coding: utf-8 -*-
"""
Скрипт применения и синхронизации локализации для мода 'splendid_slimes'.
1. Считывает переводы из new_translate.md.
2. Сохраняет в translations/mods/splendid_slimes.json.
3. Записывает напрямую в D:\ModrinthApp\profiles\Society_ Sunlit Valley\kubejs\assets\splendid_slimes\lang\ru_ru.json.
...
def apply_and_sync():
    ...
    print(f"💾 Обновлён translations/mods/splendid_slimes.json (всего {len(local_data)} ключей)")
